...
(function (State) {
    ...
    State[State["PROTOCOL"] = 1] = "PROTOCOL";
    State[State["AUTHORITY"] = 2] = "AUTHORITY";
    State[State["USERNAME"] = 3] = "USERNAME";
    State[State["PASSWORD"] = 4] = "PASSWORD";
    State[State["HOSTNAME"] = 5] = "HOSTNAME";
    State[State["PORT"] = 6] = "PORT";
    State[State["PATHNAME"] = 7] = "PATHNAME";
    State[State["SEARCH"] = 8] = "SEARCH";
    State[State["HASH"] = 9] = "HASH";
    State[State["DONE"] = 10] = "DONE";
})(State || (State = {}));
...
class Parser {
    constructor(input) {
        ...
        Object.defineProperty(this, "tokenList", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "tokenIndex", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "tokenIncrement", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 1
        ...
        Object.defineProperty(this, "componentStart", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "hostnameIPv6BracketDepth", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "shouldTreatAsStandardURL", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
    ...
    // property getter.
    parse() {
        this.tokenList = (0, path_to_regex_modified_js_1.lexer)(this.input, /*lenient=*/ true);
    ...
    computeShouldTreatAsStandardURL() {
        ...
        const regexp = (0, path_to_regex_modified_js_1.pathToRegexp)(this.makeComponentString(), 
        /*keys=*/ undefined, options);
        this.shouldTreatAsStandardURL = (0, url_utils_js_1.isSpecialScheme)(regexp);
    }
}
