...
exports.balancedAll = exports.range = exports.balanced = void 0;
...
function balancedAll(pre, post, str, includeInside = false, includeOutside = true, level = 0, arr = []) {
...
exports.balancedAll = balancedAll;
