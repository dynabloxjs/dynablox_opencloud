...
export function isAbsolutePathname(pathname, isPattern) {
    if (!pathname.length) {
        return false;
    }
    if (pathname[0] === "/") {
...
export function treatAsIPv6Hostname(value) {
...
export function isSpecialScheme(protocol_regexp) {
    if (!protocol_regexp) {
        return true;
    }
...
export function canonicalizeHash(hash, isPattern) {
...
export function canonicalizeSearch(search, isPattern) {
...
export function canonicalizeHostname(hostname, isPattern) {
...
export function canonicalizePassword(password, isPattern) {
...
export function canonicalizeUsername(username, isPattern) {
...
export function canonicalizePathname(pathname, protocol, isPattern) {
...
export function canonicalizePort(port, protocol, isPattern) {
...
export function canonicalizeProtocol(protocol, isPattern) {
...
export function protocolEncodeCallback(input) {
    if (input === "") {
        return input;
    }
...
export function usernameEncodeCallback(input) {
    if (input === "") {
        return input;
    }
    const url = new URL("https://example.com");
...
export function passwordEncodeCallback(input) {
    if (input === "") {
        return input;
    }
    const url = new URL("https://example.com");
...
export function hostnameEncodeCallback(input) {
    if (input === "") {
        return input;
    }
    if (/[\t\n\r #%/:<>?@[\]^\\|]/g.test(input)) {
...
export function ipv6HostnameEncodeCallback(input) {
    if (input === "") {
        return input;
    }
...
export function portEncodeCallback(input) {
    if (input === "") {
        return input;
    }
...
export function standardURLPathnameEncodeCallback(input) {
    if (input === "") {
        return input;
    }
    const url = new URL("https://example.com");
...
export function pathURLPathnameEncodeCallback(input) {
    if (input === "") {
        return input;
    }
...
export function searchEncodeCallback(input) {
    if (input === "") {
        return input;
    }
    const url = new URL("https://example.com");
...
export function hashEncodeCallback(input) {
    if (input === "") {
        return input;
    }
    const url = new URL("https://example.com");
