...
import { parse, tokensToRegexp, } from "./path-to-regex-modified.js";
import { canonicalizeHash, canonicalizeHostname, canonicalizePassword, canonicalizePathname, canonicalizePort, canonicalizeProtocol, canonicalizeSearch, canonicalizeUsername, DEFAULT_OPTIONS, defaultPortForProtocol, hashEncodeCallback, HOSTNAME_OPTIONS, hostnameEncodeCallback, ipv6HostnameEncodeCallback, isAbsolutePathname, isSpecialScheme, passwordEncodeCallback, PATHNAME_OPTIONS, pathURLPathnameEncodeCallback, portEncodeCallback, protocolEncodeCallback, searchEncodeCallback, standardURLPathnameEncodeCallback, treatAsIPv6Hostname, usernameEncodeCallback, } from "./url-utils.js";
import { Parser } from "./url-pattern-parser.js";
...
export class URLPattern {
    constructor(init = {}, baseURL) {
        ...
        try {
            ...
            if (defaultPortForProtocol(this.pattern.protocol) ===
                this.pattern.port) {
                this.pattern.port = "";
            }
            let component;
