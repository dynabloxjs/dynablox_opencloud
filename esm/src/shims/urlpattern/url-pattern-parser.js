...
//
import { lexer, pathToRegexp, } from "./path-to-regex-modified.js";
import { DEFAULT_OPTIONS, isSpecialScheme, protocolEncodeCallback, } from "./url-utils.js";
var State;
(function (State) {
...
export class Parser {
    ...
    computeShouldTreatAsStandardURL() {
        ...
        const regexp = pathToRegexp(this.makeComponentString(), 
