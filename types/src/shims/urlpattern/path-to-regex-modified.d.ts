...
export interface LexToken {
    type: "OPEN" | "CLOSE" | "PATTERN" | "NAME" | "CHAR" | "ESCAPED_CHAR" | "MODIFIER" | "ASTERISK" | "INVALID_CHAR" | "END";
    index: number;
    value: string;
}
/**
 ...
 */
export declare function lexer(str: string, lenient?: boolean): LexToken[];
/**
 ...
 */
declare type EncodePartCallback = (value: string) => string;
