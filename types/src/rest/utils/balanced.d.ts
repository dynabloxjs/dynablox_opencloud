 ...
 */
export declare function balanced(a: string | RegExp, b: string | RegExp, str: string): Output | void;
/**
 * For the first non-nested matching pair of `a` and `b` in `str`,
 * return an array with indexes: `[ <a index>, <b index> ]`.
 */
export declare function range(a: string, b: string, str: string): (number | undefined)[] | undefined;
export declare function balancedAll(pre: string, post: string, str: string, includeInside?: boolean, includeOutside?: boolean, level?: number, arr?: Output[]): Output[];
